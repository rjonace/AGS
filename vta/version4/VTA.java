...
class Totals{
	...
	int pointsGraded;
	int pointsUngraded;
	int pointsMaxStillPossible;
	int pointsTotalAssignment;
}
...
//			throw (new Exception("Unknown Language"));
	...
	public boolean addInputCase(String sectionName, String inputName, String correctOutput, String studentOutput, boolean correct, int points, String comments){
		...
		sections.get(sectionIndex).pointsPossible += points;
		sections.get(sectionIndex).pointsGraded += points;
	...
	private void calculateTotals(){
		for (Section a : sections){
			...
			totals.pointsGraded += a.pointsGraded;
			totals.pointsEarned += a.pointsEarned;
		}
	...
	private void createJSON(){
		...
		out.append("\"pointsUngraded\":" + this.totals.pointsUngraded + ",");
		out.append("\"pointsMaxStillPossible\":" + this.totals.pointsMaxStillPossible + ",");
		out.append("\"pointsTotalAssignment\":" + this.totals.pointsTotalAssignment);
		out.append("},");
